...
function NewsPosts(props) {
  return (
    <div className="news-posts">
      ...
      <div className="row-item">
        <div className="row-item-text"><a >See older news »</a></div>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="blog-posts">
      ...
      <div className="row-item">
        ...
        <div className="row-item-text"><a target="_blank" href="https://danielsnider.medium.com/ranking-software-frameworks-on-standardization-227c906599f7">Ranking Software Frameworks on Standardization</a></div>
      </div>
